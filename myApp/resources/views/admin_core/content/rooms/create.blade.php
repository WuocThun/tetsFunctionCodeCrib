    ...
    <main role="main" class="ml-sm-auto col">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Quản lý</a>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <textarea class="des_blog form-control ckeditor" name="description" id="editor1" rows="3"></textarea>
