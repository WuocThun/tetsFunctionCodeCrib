...
@section('main')
    <div class="container-fluid">
        <main role="main" class="ml-sm-auto col">
            ...
            <form id="form_dangtin" action="{{route('admin.roomsCore.storeCore')}}" method="POST"
                  class="form-horizontal js-form-submit-data js-frm-manage-post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    @if ($errors->any())
                    ...
                    <div class="col-md-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            ...
                                            <li style="list-style-type: square; margin-left: 15px;">Các bạn nên điền đầy
                                                đủ thông tin vào các mục để tin đăng có hiệu quả hơn.
                                            </li>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input type="text" onkeyup="ChangeToSlug();" class="form-control js-title" name="title"
                                       id="slug"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <textarea class="des_blog form-control ckeditor" name="description" id="editor1"
                                          rows="3"></textarea>
...
">
                        ...
                        <div class="form-group row mt-5">
                            <div class="col-md-12">
                                <button type="submit"
                                        class="btn btn-warning mb-5 btn-lg btn-block js-btn-hoan-tat">Đăng phòng
                                </button>
                            </div>
                        </div>
                        @endrole
                        ...
                        <div class="form-group row mt-5">
                            <div class="col-md-12">
                                <button type="submit"
                                        class="btn btn-warning mb-5 btn-lg btn-block js-btn-hoan-tat">Gửi bài cho QTV
                                </button>
                            </div>
                        </div>
                        @endrole
