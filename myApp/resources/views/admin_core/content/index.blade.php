...
@section('main')
    ...
    @include('admin_core.inc.sub_main')
        ...
        <a class="btn btn-danger btn-block desktop" href="{{route('admin.roomsCore.createCore')}}">
        ...
        <div class="list-group dashboard_list_menu mt-4">
            ...
            <a class="list-group-item" href="{{route('admin.trangChuNapThe')}}">
                <svg xmlns="http://www.w3.org/2000/svg"
                     width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                     class="feather feather-dollar-sign mr-2">
            ...
            <a class="list-group-item" href="lich-su-thanh-toan.html">
                <svg
                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="feather feather-calendar mr-2">
            ...
            <a class="list-group-item" href="cap-nhat-thong-tin-ca-nhan.html">
                <svg
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <a class="list-group-item" href="doi-so-dien-thoai.html">
                <svg
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <a class="list-group-item" href="doi-mat-khau.html">
                <svg
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" class="feather feather-lock mr-2">
            ...
            <a class="list-group-item" href="lien-he.html">
                <svg xmlns="http://www.w3.org/2000/svg"
                     width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                Liên hệ
                <svg style="position: absolute; right: 10px; top: 50%; margin-top: -8px;"
                     xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                     stroke-linejoin="round" class="feather feather-chevron-right">
                    <polyline points="9 18 15 12 9 6"></polyline>
            ...
            <a class="list-group-item js-user-logout" href="thoat.html">
                <svg
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
