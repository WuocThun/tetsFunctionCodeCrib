  ...
  border-radius: 20px;
   ...
   <div> <h3 style="text-align: center; font-weight: bold ;margin-top: 30px;">
    ...
    <div class="section-content">
      <table
        class="table table-striped-columns table"
      ...
      >
        ...
        <tbody>
          ...
          <tr>
            <td class="nowrap"><strong>Giá tuần (7 ngày)</strong></td>
            <td><span class="price-week">315.000đ</span></td>
            <td><span class="price-week">190.000đ</span></td>
            <td><span class="price-week">133.000đ</span></td>
            <td><span class="price-week">63.000đ</span></td>
            <td><span class="price-week">12.000đ</span></td>
          </tr>
          <tr>
            <td class="nowrap">
    ...
    <div class="tongmota">
      <div class="mota">
        ...
        <img src="img/demo-vipnoibat.jpg" alt="vipnoibat" />
        <img src="img/demo-vipnoibat2.jpg" alt="vipnoibat2" />
      </div>
    </div>
    <div class="tongmota">
      <div class="mota">
    ...
    <div class="cha">
      <div class="tongdg">
        <div class="danhgia">
          <div class="info">
            <img src="img/default-user.png" alt="imguser" />
            <aside>
          ...
          <p>
            ...
            thử đăng tin lên website phongtro123.com, đâu tầm 2 ngày thì đã có 3
    ...
    <div class="tongtt">
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="img/cash.svg" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="img/momo.png" alt="bank-transfer" />
          </div>
          <strong>MOMO</strong>
        </div>
      </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="img/zalopay.png" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="img/qr-code.png" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="img/payment-method.svg" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img" style="margin-left: 20px">
            <img src="img/online-store.svg" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="img/credit-card.png" alt="bank-transfer" />
          </div>
